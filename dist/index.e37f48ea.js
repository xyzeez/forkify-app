...
},{"core-js/modules/esnext.symbol.dispose.js":"b9ez5","core-js/modules/web.immediate.js":"49tUX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","regenerator-runtime/runtime":"dXNgZ","./model.js":"Y4A21","regenerator-runtime":"dXNgZ","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./views/bookmarksView.js":"4Lqzq","./views/addRecipeView.js":"i6DNj","./config.js":"k5Hzs"}],"b9ez5":[function(require,module,exports) {
"use strict";
...
const loadRecipe = async (id)=>{
    try {
        const data = await getJSON(`${(0, _configJs.API_URL)}${id}?key=${(0, _configJs.API_KEY)}`);
...
const uploadRecipe = async (newRecipe)=>{
    try {
        const ingredients = Object.entries(newRecipe).filter((recipe)=>recipe[0].startsWith("ingredient") && recipe[1] !== "").map((ing)=>{
...
const API_KEY = "23c9f2e5-f811-4de8-8387-40c306e895d6";
const TIMEOUT_SEC = 5;
...
},{"../../img/icons.svg":"cMpiy","fracty":"hJO4d","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./view.js":"bWlJ9"}],"cMpiy":[function(require,module,exports) {
...
},{"../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","regenerator-runtime":"dXNgZ"}],"9OQAM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"../../img/icons.svg":"cMpiy","./view.js":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6z7bi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (currPage === 1 && numPages > 1) return this._generateMarkupNextBtn(currPage);
        if (currPage === 1 && numPages === 1) return "";
        if (currPage === numPages && numPages > 1) return this._generateMarkupPrevBtn(currPage);
        if (currPage < numPages) return this._generateMarkupPrevBtn(currPage) + this._generateMarkupNextBtn(currPage);
    }
...
},{"../../img/icons.svg":"cMpiy","./view.js":"bWlJ9","./previewView.js":"1FDQ6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i6DNj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"../../img/icons.svg":"cMpiy","./view.js":"bWlJ9","./previewView.js":"1FDQ6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kYpTN","aenu9"], "aenu9", "parcelRequire3a11")
